...
const BRAND_IMAGES: Record<string, string> = {
  ...
  "Hermès":                    "https://i.pinimg.com/564x/49/b2/b3/49b2b3039e31075388e3dd0f6824e6ba.jpg",
  ...
  "Azzaro":                    "https://images.seeklogo.com/logo-png/62/1/azzaro-logo-png_seeklogo-625152.png",
...
const filteredBrands = useMemo(() => {
  ...
  return (
<div className="min-h-screen w-screen flex flex-col relative p-6 lg:p-10 pb-40 overflow-x-hidden" style={{ backgroundColor: "#1F1D7B" }}>
