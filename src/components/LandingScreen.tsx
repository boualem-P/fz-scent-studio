...
const LandingScreen = ({ onSelectGender }: LandingScreenProps) => {
  return (
    <div className="relative min-h-screen flex flex-col items-center justify-center p-6 text-center bg-black overflow-hidden">
      
      {/* INTÉGRATION VIDÉO ARRIÈRE-PLAN */}
      <div className="absolute inset-0 z-0">
        ...
        >
          {/* Lien vers une vidéo libre de droits (Ambiance Luxe / Particules dorées) */}
          <source 
            src="https://cdn.pixabay.com/video/2021/09/01/87105-595304381_large.mp4" 
            type="video/mp4" 
          />
        </video>
        {/* Voile noir pour garantir la lisibilité du texte doré */}
