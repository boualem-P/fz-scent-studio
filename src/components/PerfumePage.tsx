      ...
      <div className="max-w-7xl mx-auto px-8 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-24">
          ...
          <div className="lg:col-span-5 space-y-16">
            <div className="perfume-img-container gold-frame aspect-[3/4.5] !h-auto">
              <img 
                src={perfume.image} 
            ...
            <p className="text-zinc-400 text-3xl leading-relaxed font-extralight italic px-10 border-l border-white/5 italic italic">"{perfume.description}"</p>
          </div>
        ...
        {/* --- CARROUSSEL RECOMMANDATIONS CORRIGÉ --- */}
        <div className="mt-48 pt-24 border-t border-white/[0.05]">
          <div className="flex items-center justify-between mb-16 px-4">
            ...
            <div className="flex gap-4 items-center">
               <span className="text-[9px] uppercase tracking-[0.4em] text-zinc-500 font-light">Slide to explore</span>
            ...
            >
              {recommendations.map((rec) => (
                <motion.button key={rec.id} onClick={() => onSelectPerfume(rec)} className="group w-[320px] text-left space-y-8" whileHover={{ y: -15 }}>
                  <div className="perfume-img-container gold-frame !h-[420px] bg-zinc-900/50">
                    <img 
                      src={rec.image} 
                      className="perfume-img opacity-60 group-hover:opacity-100" 
                      alt={rec.name}
                    />
                    <div className="absolute inset-0 opacity-[0.18] mix-blend-overlay bg-[url('https://grainy-gradients.vercel.app/noise.svg')]" />
                    <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-1000 flex items-end p-8">
