  ...
  return (
    <div className="relative min-h-screen bg-[#050505] text-white overflow-x-hidden selection:bg-amber-200 selection:text-black font-sans">
      ...
      <div className="max-w-5xl mx-auto px-4 pt-4 pb-16 relative z-10">
        ...
        >
          <h1 className="text-3xl md:text-5xl font-extralight italic tracking-tight uppercase leading-none mb-2">
            {perfume.name}
          </h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 items-start">
          ...
          <div className="space-y-4">
            ...
            <div className="relative px-4 py-3 border-l border-amber-500/20 bg-white/[0.02] rounded-r-xl">
              <p className="text-zinc-400 text-sm leading-relaxed font-extralight italic">
                {perfume.description}
              </p>
            </div>
          </div>

          {/* COLONNE DROITE — Jauges + Notes */}
          <div className="space-y-5">
            <h3 className="text-[10px] uppercase tracking-[0.5em] text-zinc-600 font-bold border-b border-white/5 pb-3">
              ...
              <div key={i} className="space-y-2">
                ...
                <div className="flex flex-wrap gap-3 pt-1">
                  {s.notes.map((note, idx) => (
                    <div
                      key={idx}
                      className="flex flex-col items-center gap-1 cursor-pointer group/note"
                    ...
                    >
                      <div className="note-bubble-container !w-10 !h-10">
                        <img
                          ...
                          alt={note.name}
                          onError={(e) => {
                            (e.target as HTMLImageElement).src = "https://images.unsplash.com/photo-1596040033229-a9821ebd058d?w=80&h=80&fit=crop&q=80";
                          }}
                        />
                      </div>
        ...
        <div className="mt-10 pt-6 border-t border-white/[0.05]">
          ...
          <div ref={carouselRef} className="cursor-grab active:cursor-grabbing overflow-hidden">
            <motion.div
              drag="x"
              dragConstraints={{ right: 0, left: -((recommendations.length * 200) - 600) }}
            ...
            >
              {recommendations.map((rec) => (
                <motion.button
                  ...
                  className="group w-[160px] text-left space-y-2"
                  whileHover={{ y: -4 }}
                >
