...
const ATMOSPHERES = [
  ...
  { id: 'soir', label: 'Vacances & Sorties', icon: "🍹", desc: "Intense & magnétique", img: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRcPYhY9g09b-IdPYHl9bjjlmujBDOjqwY9Iw&s", group: 'occasions' },
