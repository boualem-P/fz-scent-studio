...
export const PERFUMES: Perfume[] = [
  ...
  },
  {
    ...
    description: "Un parfum construit autour de l'association de l'Iris et du Néroli.",
    gender: "homme",
    concentration: "Eau de Toilette",
  ...
  },
  {
    ...
    description: "L'homme idéal est un mythe. Son parfum, une réalité.",
    gender: "homme",
    concentration: "Eau de Toilette",
  ...
  },
  {
    ...
    gender: "femme",
    concentration: "Eau de Parfum",
    topNotes: ["Truffe noire", "Gardénia", "Cassis", "Ylang-ylang", "Jasmin", "Bergamote", "Mandarine"],
